  ...
  if(view==="cop")return(<Wrapper>
    ...
    <GlassCard>
      ...
      {!cop.existingStrainId&&<><label style={{fontSize:12,fontWeight:500,color:"rgba(240,235,225,0.5)",display:"block",marginBottom:6}}>parent strains <span style={{fontWeight:400,fontStyle:"italic"}}>(optional)</span></label>
        {!cop.unknownLineage&&<div style={{display:"flex",gap:8,marginBottom:8}}><input value={cop.parent1} onChange={e=>setCop({...cop,parent1:e.target.value})} placeholder="parent 1" style={{flex:1,background:"rgba(240,235,225,0.06)",borderRadius:8,padding:"10px 14px",fontSize:14,color:"#F0EBE1",border:"0.5px solid rgba(240,235,225,0.1)",fontFamily:"inherit",outline:"none"}}/><span style={{display:"flex",alignItems:"center",color:"rgba(240,235,225,0.3)"}}>x</span><input value={cop.parent2} onChange={e=>setCop({...cop,parent2:e.target.value})} placeholder="parent 2" style={{flex:1,background:"rgba(240,235,225,0.06)",borderRadius:8,padding:"10px 14px",fontSize:14,color:"#F0EBE1",border:"0.5px solid rgba(240,235,225,0.1)",fontFamily:"inherit",outline:"none"}}/></div>}
